...
| `apps/web/src/pages/AgendaPage.tsx`<br>`apps/web/src/state.ts`<br>`apps/web/src/tickets.ts`<br>`apps/web/src/edition.ts`<br>`apps/web/src/screening-counts.ts`<br>`apps/web/src/screening-discussion.ts`<br>`apps/web/src/app/App.tsx`<br>`apps/web/src/main.tsx`<br>`apps/web/src/components/ScreeningCard.tsx`<br>`apps/web/src/components/ScreeningTickets.tsx`<br>`apps/web/src/components/ScreeningDiscussionDialog.tsx`<br>`apps/web/src/components/TransferAddDialog.tsx`<br>`apps/web/src/components/screening-social.css`<br>`apps/api/src/reactions.ts`<br>`apps/api/src/pagination.ts`<br>`apps/api/src/screening-stats.ts`<br>`apps/api/src/screening-stats-store.ts`<br>`apps/api/src/screening-discussion.ts`<br>`apps/api/src/screening-discussion-store.ts`<br>`apps/api/migrations/0005_screening_social.sql`<br>`packages/contracts/src/reactions.ts`<br>`packages/contracts/src/screening.ts` | `screening-social` |
| `apps/web/src/components/ChangelogDialog.tsx`<br>`apps/web/src/changelog.ts`<br>`apps/web/src/app/store.tsx`<br>`apps/web/public/changelog.json`<br>`tools/build_changelog.py` | ⚠ `data-update`(不存在) |
| **任何改动都跑** | `smoke` |
