...
| `apps/web/src/components/ExportDialog.tsx`<br>`apps/web/src/components/SettingsDialog.tsx`<br>`apps/web/src/components/InfoDialogs.tsx`<br>`apps/web/src/components/FilterBar.tsx` | `review-state-export` · `review-shared` · `workflows` · `parity-dialogs` · `rush` |
...
| `apps/web/src/pages/RedBlackPage.tsx`<br>`apps/web/src/pages/redblack-parity.css`<br>`apps/web/src/redblack.ts`<br>`apps/web/src/film-votes.ts`<br>`apps/api/src/film-vote-stats.ts`<br>`apps/api/src/film-vote-store.ts`<br>`apps/api/migrations/0006_ordinary_silvermane.sql` | ⚠ `redblack`(不存在) |
...
| `apps/web/src/pages/AgendaPage.tsx`<br>`apps/web/src/state.ts`<br>`apps/web/src/tickets.ts`<br>`apps/web/src/edition.ts`<br>`apps/web/src/screening-counts.ts`<br>`apps/web/src/screening-discussion.ts`<br>`apps/web/src/app/App.tsx`<br>`apps/web/src/main.tsx`<br>`apps/web/src/components/ScreeningCard.tsx`<br>`apps/web/src/components/ScreeningTickets.tsx`<br>`apps/web/src/components/ScreeningDiscussionDialog.tsx`<br>`apps/web/src/pages/DiscussionsPage.tsx`<br>`apps/web/src/components/TransferAddDialog.tsx`<br>`apps/web/src/components/screening-social.css`<br>`apps/api/src/reactions.ts`<br>`apps/api/src/pagination.ts`<br>`apps/api/src/screening-stats.ts`<br>`apps/api/src/screening-stats-store.ts`<br>`apps/api/src/screening-discussion.ts`<br>`apps/api/src/screening-discussion-store.ts`<br>`apps/api/migrations/0005_screening_social.sql`<br>`packages/contracts/src/reactions.ts`<br>`packages/contracts/src/screening.ts` | `screening-social` |
...
| **任何改动都跑** | `smoke` |
| **命中即全量** | `apps/web/src/style.css` · `apps/web/index.html` · `package.json` · `package-lock.json` · `playwright.react.config.ts` · `tsconfig.tests.json` · `vitest.config.ts` · `apps/web/vite.config.ts` · `apps/web/public/schedule.json` · `apps/web/public/venues.json` · `apps/web/public/films.json` · `apps/web/public/festival-extras.json` · `apps/web/public/changelog.json` |
