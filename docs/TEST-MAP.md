...
| `apps/web/src/components/ChangelogDialog.tsx`<br>`apps/web/src/changelog.ts`<br>`apps/web/src/app/store.tsx`<br>`apps/web/public/changelog.json`<br>`tools/build_changelog.py` | `data-update` |
| `apps/web/src/pages/RushAnalysisPage.tsx`<br>`apps/web/src/pages/rush-analysis.css`<br>`apps/web/src/rush-analysis.ts`<br>`apps/web/src/capacity.ts`<br>`apps/web/src/ticket-stats.ts`<br>`apps/web/src/state.ts`<br>`apps/api/src/ticket-stats.ts`<br>`apps/api/src/ticket-stats-store.ts`<br>`apps/api/migrations/0007_screening_ticket.sql`<br>`tools/build_venue_capacity.py` | ⚠ `rush-analysis`(不存在) |
