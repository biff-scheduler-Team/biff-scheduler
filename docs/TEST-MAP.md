...
| `apps/web/src/pages/RedBlackPage.tsx`<br>`apps/web/src/pages/redblack-parity.css`<br>`apps/web/src/redblack.ts`<br>`apps/web/src/use-in-view.ts`<br>`apps/web/src/use-dpr.ts`<br>`apps/web/src/sticker-canvas-guard.ts`<br>`apps/web/src/sticker-sprite.ts`<br>`apps/web/src/components/StickerCanvas.tsx`<br>`apps/web/src/film-votes.ts`<br>`apps/api/src/film-vote-stats.ts`<br>`apps/api/src/film-vote-store.ts`<br>`apps/api/migrations/0006_ordinary_silvermane.sql` | `redblack` |
