...
const schedule = JSON.parse(
  readFileSync("public/schedule.json", "utf8"),
) as ScheduleFile;
const venues = (
  JSON.parse(readFileSync("public/venues.json", "utf8")) as VenuesFile
).venues;
const films = (
  JSON.parse(readFileSync("public/films.json", "utf8")) as FilmsFile
).films;
...
const oldSource = readFileSync(
  "e2e/fixtures/legacy-state.ts.txt",
  "utf8",
).replace(
