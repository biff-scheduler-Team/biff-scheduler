...
test("讨论区:集合成方格墙、按场次定位;发帖门闸与社区提醒只留一条", async ({ page }) => {
  ...
  //   `PLAN-20260916232230`、「数据分析」由 `PLAN-20260920161837` 加到导航里;
  //   本断言是「导航整体顺序」的快照,故一并列出
  //   (2026-09-17 补上「吃喝」:它上线时漏改这里,快照在 main 上就已经红了;2026-09-20 同理补这一项;
  //    该项 2026-09-20 由「抢票分析」更名为「数据分析」,见 `PLAN-20260920193032`)。
